...
export const SKILLS = [
  ...
  // -------------------------
  {
    ...
    rarity: C,
    max_stacks: 8,
    dial: { type: "weaponState", stateMods: { repeaterWindupGainMult: 0.12 } },
    mods: {},
  },
  {
    id: "p_breath_control",
    cls: "repeater",
    name: "Breath Control",
    desc: "Cyclone proc chance increases; windup decays slower.",
    rarity: C,
    max_stacks: 6,
    dial: { type: "weaponState", stateMods: { repeaterCycloneProcChanceAdd: 0.002, repeaterWindupDecayMult: -0.08 } },
    mods: {},
  },
  {
  ...
  },
  {
    ...
    cls: "repeater",
    name: "Gust Spray",
    desc: "Cyclone procs also emit a gust hit.",
    rarity: U,
    max_stacks: 4,
    dial: { type: "weaponState", stateMods: { repeaterGustEnable: 1, repeaterGustRateMult: 0.12 } },
    mods: {},
  },
  ...
  // Pierce path (mutually exclusive with ricochet path)
  {
    ...
    rarity: C,
    max_stacks: 5,
    exclusiveGroup: "repeater:path",
    exclusiveKey: "pierce",
    flagAdds: ["repeater:path:pierce"],
  ...
  },
  {
    ...
    desc: "Cyclone bursts gain extra pierce.",
    rarity: R,
    max_stacks: 1,
    isKeystone: true,
    exclusiveGroup: "repeater:path",
    exclusiveKey: "pierce",
    requiresAny: ["repeater:path:pierce"],
    dial: { type: "weaponState", stateMods: { repeaterAirLanceEnable: 1 } },
    mods: {},
  },
  ...
  // Ricochet path
  {
    ...
    flagAdds: ["repeater:path:ricochet"],
  ...
  },
  {
    ...
    desc: "Cyclone bursts gain extra ricochet.",
    rarity: R,
    max_stacks: 1,
    isKeystone: true,
    exclusiveGroup: "repeater:path",
    exclusiveKey: "ricochet",
    requiresAny: ["repeater:path:ricochet"],
    dial: { type: "weaponState", stateMods: { repeaterPinballEnable: 1 } },
    mods: {},
  },
  ...
  // Occult layer (works with either path)
  {
    ...
    rarity: U,
    max_stacks: 6,
    dial: { type: "status", statusId: "repeater:hex", stateMods: { repeaterHexEnable: 1, repeaterHexDurationMult: 0.12 } },
    mods: {},
  },
  {
    ...
    rarity: R,
    max_stacks: 4,
    dial: { type: "weaponState", stateMods: { repeaterSoulPressureEnable: 1, repeaterCycloneSustainMult: 0.08 } },
    mods: {},
  },
  {
    ...
    rarity: R,
    max_stacks: 3,
    dial: { type: "status", statusId: "repeater:debtPop", stateMods: { repeaterDebtPopEnable: 1, repeaterDebtPopCoeffMult: 0.12 } },
    mods: {},
  },
  {
    ...
    max_stacks: 1,
    isKeystone: true,
    dial: { type: "weaponState", stateMods: { repeaterReapersVortexEnable: 1 } },
    mods: {},
  },

  // -------------------------
  // STAFF (Lightning + Occult) — Option A
  // -------------------------
  {
  ...
  // -------------------------
  {
    ...
    cls: "scythe",
    name: "Grave Reach",
    desc: "Scythe range increased.",
    rarity: C,
    max_stacks: 6,
    dial: { type: "weaponState", stateMods: { scytheRangeMult: 0.06 } },
    mods: {},
  },
  {
    id: "y_harvest_brand",
    cls: "scythe",
    name: "Harvest Brand",
    desc: "Harvest Marks last longer.",
    rarity: C,
    max_stacks: 6,
    dial: { type: "weaponState", stateMods: { scytheMarkDurationMult: 0.12 } },
    mods: {},
  },
  {
    id: "y_ossuary_throng",
    cls: "scythe",
    name: "Ossuary Throng",
    desc: "+1 golem cap per stack.",
    rarity: U,
    max_stacks: 3,
    dial: { type: "weaponState", stateMods: { scytheGolemCapAdd: 1 } },
    mods: {},
  },
  {
    id: "y_bone_mending",
    cls: "scythe",
    name: "Bone Mending",
    desc: "Overflow captures heal golems more.",
    rarity: U,
    max_stacks: 4,
    dial: { type: "weaponState", stateMods: { scytheGolemHealPctAdd: 0.03 } },
    mods: {},
  },
  {
    id: "y_golem_fortitude",
    cls: "scythe",
    name: "Golem Fortitude",
    desc: "Summoned golems have more health.",
    rarity: U,
    max_stacks: 5,
    dial: { type: "weaponState", stateMods: { scytheGolemHpAdd: 6 } },
    mods: {},
  },
  {
    id: "y_reaping_edge",
    cls: "scythe",
    name: "Reaping Edge",
    desc: "Scythe attacks deal more damage.",
    rarity: R,
    max_stacks: 5,
    dial: { type: "weaponState", stateMods: { scytheDamageCoeffMult: 0.08 } },
    mods: {},
  },
  {
    id: "y_keystone_golemcraft",
    cls: "scythe",
    name: "Keystone: Golemcraft",
    desc: "Your golems slam harder.",
    rarity: R,
    max_stacks: 1,
    isKeystone: true,
    dial: { type: "weaponState", stateMods: { scytheGolemSlamCoeffMult: 0.25 } },
    mods: {},
  },
  {
    id: "y_dual_scythe_path_stub",
    cls: "scythe",
    name: "Path (Later): Twin Scythes",
    desc: "Fast-melee path placeholder (summoner ships first).",
    rarity: E,
    max_stacks: 1,
    isKeystone: true,
    dial: { type: "weaponState", stateMods: { scytheDualScythesEnable: 1 } },
    mods: {},
  },
];
